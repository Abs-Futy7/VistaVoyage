  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border border-gray-300 bg-white hover:bg-gray-50 rounded-md inline-flex items-center justify-center"
        ),
